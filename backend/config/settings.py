...
if os.getenv("GDAL_LIBRARY_PATH"):
    os.environ.setdefault("GDAL_LIBRARY_PATH", os.getenv("GDAL_LIBRARY_PATH"))
if os.getenv("GEOS_LIBRARY_PATH"):
    os.environ.setdefault("GEOS_LIBRARY_PATH", os.getenv("GEOS_LIBRARY_PATH"))
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "wellbore_platform"),
        "USER": os.getenv("POSTGRES_USER", "wellbore"),
